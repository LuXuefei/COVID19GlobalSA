% * Codes for Figs.4,6 and 7, Sensitivity Analysis of SEIR model
...
ipnames = {'\alpha', '\beta', '\gamma^{-1}', '\delta', 'I_0', 'Interv.'};
...
% % correlated case
%load('SEIRdata20200420_Italy_correlation')
...
% % correlated case
% load('InteractionsItaly_corr.mat')
%
xx = x; xx(end,:)=[];
ffmcc = ffmc;
n= size(x,1);
...
%% Fig. 6. The portions of the output variance
